...
extension StoryType {
    func coachingTipsForMale(size: CGFloat) -> [AttributedString] {
        switch self {
        case .hisFault:
            return []
        case .herFault:
            return herFaultCoachingTips(size: size) //herFaultStories
        case .myFault:
            return myFaultCoachingTipsForMale(size: size) //myFaultStoriesForMale
        case .toxic:
            return toxicChatCoachingTipsForMale(size: size) //toxicChatStoriesForMale
        case .giving:
            return givingTalkCoachingTips(size: size) //givingTalkStories
        case .receiving:
            return []
        case .sweet:
            return sweetTalkCoachingTipsForMale(size: size) //sweetTalkStoriesForMale
        }
    }
    
    func herFaultCoachingTips(size: CGFloat) -> [AttributedString] {
    ...
    func myFaultCoachingTipsForMale(size: CGFloat) -> [AttributedString] {
        var tip1: AttributedString {
    ...
    func toxicChatCoachingTipsForMale(size: CGFloat) -> [AttributedString] {
        var tip1: AttributedString {
    ...
    func givingTalkCoachingTips(size: CGFloat) -> [AttributedString] {
        var tip1: AttributedString {
    ...
    func sweetTalkCoachingTipsForMale(size: CGFloat) -> [AttributedString] {
